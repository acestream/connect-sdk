...
public class CastWebAppSession extends WebAppSession {
    ...
    @Override
    public void playMedia(String url, String mimeType, String title, String description, String iconSrc, boolean shouldLoop, float startPosition, MediaPlayer.LaunchListener listener) {
        service.playMedia(url, mimeType, title, description, iconSrc, shouldLoop, startPosition, listener);
    }
