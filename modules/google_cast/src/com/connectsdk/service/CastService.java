...
public class CastService extends DeviceService implements MediaPlayer, MediaControl, VolumeControl, WebAppLauncher {
    ...
    static class CastClient {
        ...
        public void setMessageReceivedCallbacks(
            ...
            Log.d(Util.T, "setMessageReceivedCallbacks: namespace=" + mMediaPlayer.getNamespace());
            try {
        ...
        public void removeMessageReceivedCallbacks(GoogleApiClient mApiClient,
            ...
            Log.d(Util.T, "removeMessageReceivedCallbacks: namespace=" + namespace);
            try {
        ...
        public PendingResult<ApplicationConnectionResult> launchApplication(
            ...
            Log.d(Util.T, "launchApplication: appId=" + mediaAppId);
            try {
        ...
        public PendingResult<Status> stopApplication(GoogleApiClient mApiClient, String sessionId)
            ...
            Log.d(Util.T, "stopApplication: sessionId=" + sessionId);
            try {
        ...
        public PendingResult<ApplicationConnectionResult> joinApplication(
            ...
            Log.d(Util.T, "joinApplication: appId=" + appId);
            try {
    ...
    public void connect() {
        ...
        if (mApiClient == null) {
            Log.d(Util.T, "connect: no api client, create it");
            mApiClient = createApiClient();
        }

        // anton
        Log.d(Util.T, "connect: device=" + castDevice.getIpAddress() + " connected=" + connected + " api_isConnecting=" + mApiClient.isConnecting() + " api_isConnected=" + mApiClient.isConnected());

        if(mApiClient.isConnected()) {
            if(!connected && mConnectionCallbacks != null) {
                // anton: api client is connected but we didn't finish full connection process
    ...
    public void disconnect() {
        ...
        if (mApiClient != null && mApiClient.isConnected()) {
            try {
                Log.d(Util.T, "disconnect: leave application");
                mCastClient.leaveApplication(mApiClient);
            } catch (CastClientException e) {
                Log.e(Util.T, "Closing application error", e);
            }

            Log.d(Util.T, "disconnect: disconnect api client");
            mApiClient.disconnect();
        }
        else {
            Log.d(Util.T, "disconnect: api client is not connected");
        }
    ...
    public void play(final ResponseListener<Object> listener) {
        ...
        runCommand("play", connectionListener);
    }
    ...
    public void pause(final ResponseListener<Object> listener) {
        ...
        runCommand("pause", connectionListener);
    }
    ...
    public void stop(final ResponseListener<Object> listener) {
        ...
        runCommand("stop", connectionListener);
    }
    ...
    @Override
    public boolean isMediaControlConnected() {
    ...
    public void seek(final long position, final ResponseListener<Object> listener) {
        ...
        runCommand("seek", connectionListener);
    }
    ...
    private void attachMediaPlayer() {
        // anton
        Log.d(Util.T, "attachMediaPlayer: exists=" + (mMediaPlayer != null));

        // anton: reattach if already created
        //if (mMediaPlayer != null) {
        //    return;
        //}
    ...
    private void playMedia(String url, SubtitleInfo subtitleInfo, String mimeType, String title,
                          String description, String iconSrc, boolean shouldLoop, float startPosition,
    ...
    public void playMedia(String url, String mimeType, String title,
                          String description, String iconSrc, boolean shouldLoop, float startPosition,
                          LaunchListener listener) {
        playMedia(url, null, mimeType, title, description, iconSrc, shouldLoop, startPosition, listener);
    }
    ...
    public void playMedia(MediaInfo mediaInfo, boolean shouldLoop, LaunchListener listener) {
        ...
        if (mediaInfo != null) {
            ...
            title = mediaInfo.getTitle();
            desc = mediaInfo.getDescription();
            startPosition = mediaInfo.getStartPosition();
        ...
        playMedia(mediaUrl, subtitle, mimeType, title, desc, iconSrc, shouldLoop, startPosition, listener);
    }
    ...
    private void playMedia(final com.google.android.gms.cast.MediaInfo mediaInformation, final String mediaAppId, final LaunchListener listener) {
        final ApplicationConnectionResultCallback webAppLaunchCallback =
            ...
            public void onSuccess(final WebAppSession webAppSession) {
                ...
                runCommand("loadMedia", connectionListener);
            }
        ...
        ConnectionListener connectionListener = new ConnectionListener() {
            ...
            public void onConnected() {
                try {
                    Log.d(Util.T, "playMedia: currentApp=" + currentAppId + " newApp=" + mediaAppId);

                    // anton: always relaunch
        ...
        runCommand("launchApplication", connectionListener);
    }
    ...
    public void closeMedia(final LaunchSession launchSession, final ResponseListener<Object> listener) {
        ...
        runCommand("closeMedia", connectionListener);
    }
    ...
    public void launchWebApp(final String webAppId, final boolean relaunchIfRunning, final WebAppSession.LaunchListener listener) {
        ...
        runCommand("launchWebApp", connectionListener);
    }
    ...
    public void joinApplication(final ResponseListener<Object> listener) {
        ...
        runCommand("joinApplication", connectionListener);
    }
    ...
    public void joinWebApp(final LaunchSession webAppLaunchSession, final WebAppSession.LaunchListener listener) {
        ...
        runCommand("joinWebApp", connectionListener);
    }
    ...
    public void closeWebApp(LaunchSession launchSession, final ResponseListener<Object> listener) {
        ...
        runCommand("closeWebApp", connectionListener);
    }
    ...
    public void setVolume(final float volume, final ResponseListener<Object> listener) {
        ...
        runCommand("setVolume", connectionListener);
    }
    ...
    public void setMute(final boolean isMute, final ResponseListener<Object> listener) {
        ...
        runCommand("setMute", connectionListener);
    }
    ...
    private class CastListener extends Cast.Listener {
        ...
        public void onApplicationStatusChanged() {
                    ...
                    if (mApiClient != null) {
                        ...
                        try {
                            ...
                            if (applicationMetadata != null) {
                                currentAppId = applicationMetadata.getApplicationId();
                                Log.d(Util.T, "onApplicationStatusChanged: id=" + applicationMetadata.getApplicationId());
                            }
                        } catch (CastClientException e) {
            ...
            runCommand("onApplicationStatusChanged", connectionListener);
        }
        ...
        public void onVolumeChanged() {
            ...
            runCommand("onVolumeChanged", connectionListener);
        }
    }
    ...
    private class ConnectionCallbacks implements GoogleApiClient.ConnectionCallbacks {
        ...
        public void onConnected(Bundle connectionHint) {
            ...
            if (mApiClient != null && mApiClient.isConnected()) {
                try {
                    // anton
                    Log.d(Util.T, "ConnectionCallbacks.onConnected: join application");
                ...
                // anton
                if(mApiClient == null) {
                    Log.d(Util.T, "ConnectionCallbacks.onConnected: api client is null");
                }
                else {
                    Log.d(Util.T, "ConnectionCallbacks.onConnected: api client is not connected");
                }
            }
        }
        ...
        private void onJoinApplicationResult(ApplicationConnectionResult result) {
            // anton
            Log.d(Util.T, "onJoinApplicationResult: success=" + result.getStatus().isSuccess());
        ...
        private void joinFinished() {
            // anton
            Log.d(Util.T, "joinFinished: mWaitingForReconnect=" + mWaitingForReconnect + " connected=" + connected);
    ...
    private class ConnectionFailedListener implements GoogleApiClient.OnConnectionFailedListener {
        ...
        public void onConnectionFailed(final ConnectionResult result) {
            Log.d(Util.T, "ConnectionFailedListener.onConnectionFailed: connected=" + connected + " result=" + (result != null ? result: ""));
            ...
            Util.runOnUI(new Runnable() {
                ...
                public void run() {
                    if (listener != null) {
                        Log.d(Util.T, "ConnectionFailedListener.onConnectionFailed: notify listener");
                        ...
                        Log.d(Util.T, "ConnectionFailedListener.onConnectionFailed: no listener");
                    }
    ...
    private class ApplicationConnectionResultCallback implements
        ...
        public void onResult(ApplicationConnectionResult result) {
            ...
            if (status.isSuccess()) {
                ...
                Log.w(Util.T, "failed to launch application: " + status.getStatusMessage());
                if (listener != null) {
    ...
    private void runCommand(String commandName, ConnectionListener connectionListener) {
        //TODO: skip commands when not connected, or add to queue, or report failure?
        if (mApiClient != null && mApiClient.isConnected()) {
            Log.d(Util.T, "runCommand: run now: name=" + commandName);
            connectionListener.onConnected();
        }
        else if(!connected) {
            Log.d(Util.T, "runCommand: we're disconnected, skip: name=" + commandName);
        }
        else {
            Log.d(Util.T, "runCommand: add to queue: name=" + commandName);
            connect();
