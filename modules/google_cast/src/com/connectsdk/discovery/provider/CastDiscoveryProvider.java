...
public class CastDiscoveryProvider implements DiscoveryProvider {
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteAdded(MediaRouter router, RouteInfo route) {
            ...
            Log.d(Util.T, "onRouteAdded: name=" + route.getName() + " desc=" + route.getDescription());
            handleRouteAdded(router, route);
        }

        public void handleRouteAdded(MediaRouter router, RouteInfo route) {
        ...
        public void onRouteChanged(MediaRouter router, RouteInfo route) {
            ...
            Log.d(Util.T, "onRouteChanged: name=" + route.getName() + " desc=" + route.getDescription());

            // anton: always check that route is added
            handleRouteAdded(router, route);
        }
        ...
        public void onRouteRemoved(final MediaRouter router, final RouteInfo route) {
            ...
            Log.d(Util.T, "onRouteRemoved: name=" + route.getName() + " desc=" + route.getDescription() + " uuid=" + uuid);
            ...
            if (removeRoutesTimer == null) {
                ...
                removeRoutesTimer.schedule(new TimerTask() {
                    @Override
                    public void run() {
                        Log.d(Util.T, "onRouteRemoved: fire remove timer");
        ...
        private void removeServices(RouteInfo route) {
            for (String uuid : removedUUID) {
                ...
                if (service != null) {
                    ...
                    Log.d(Util.T, "removeServices: service not found: uuid=" + uuid);
                }
            }
            removedUUID.clear();
        }
