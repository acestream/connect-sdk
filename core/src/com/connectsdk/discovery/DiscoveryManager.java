...
public class DiscoveryManager implements ConnectableDeviceListener, DiscoveryProviderListener, ServiceConfigListener {
        ...
        receiver = new BroadcastReceiver() { 
            ...
            public void onReceive(Context context, Intent intent) { 
                ...
                if (action.equals(WifiManager.NETWORK_STATE_CHANGED_ACTION)) {
                    ...
                    case CONNECTED:
                        Log.d(Util.T, "Network connection is connected: searching=" + mSearching);
                        if (mSearching) {
    ...
    public void handleDeviceAdd(ConnectableDevice device) {
        ...
        // anton
        Log.d(Util.T, "handleDeviceAdd: device=" + device.getIpAddress() + " compatible=" + deviceIsCompatible(device));
    ...
    public void handleDeviceUpdate(ConnectableDevice device) {
        ...
        // anton
        Log.d(Util.T, "handleDeviceUpdate: device=" + device.getIpAddress() + " compatible=" + deviceIsCompatible(device));
    ...
    public void onCapabilityUpdated(ConnectableDevice device, List<String> added, List<String> removed) {
        Log.d(Util.T, "onCapabilityUpdated: device=" + device.getFriendlyName() + " added=" + added.toString() + " removed=" + removed.toString());
    ...
    @Override public void onDeviceDisconnected(ConnectableDevice device, boolean cleanShutdown) { }
    ...
    public void onServiceAdded(DiscoveryProvider provider, ServiceDescription serviceDescription) {
        Log.d(Util.T, "Service added: name=" + serviceDescription.getFriendlyName() + " id=" + serviceDescription.getServiceID() + " uuid=" + serviceDescription.getUUID());
...
//        device.setLastSeenOnWifi(currentSSID);
        ...
        // anton
        Log.d(Util.T, "onServiceAdded: device=" + device.getIpAddress() + " isNew=" + deviceIsNew + " countServices=" + device.getServices().size());
    ...
    public void onServiceRemoved(DiscoveryProvider provider, ServiceDescription serviceDescription) {
        ...
        Log.d(Util.T, "onServiceRemoved: friendlyName=" + serviceDescription.getFriendlyName() + " id=" + serviceDescription.getServiceID());
    ...
    public void addServiceDescriptionToDevice(ServiceDescription desc, ConnectableDevice device) {
        ...
        // anton
        Log.d(Util.T, "addServiceDescriptionToDevice: hasType=" + hasType + " hasService=" + hasService);
        ...
        if (deviceService != null) {
            // anton
            Log.d(Util.T, "addServiceDescriptionToDevice: add service to device: deviceServiceClass=" + deviceServiceClass);
            deviceService.setServiceDescription(desc);
            device.addService(deviceService);
        }
        else {
            // anton
            Log.d(Util.T, "addServiceDescriptionToDevice: deviceService is null");
        }
    }
    // @endcond
}
