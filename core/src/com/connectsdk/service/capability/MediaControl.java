...
public interface MediaControl extends CapabilityMethods {
     ...
     */
    //NOTE: add new values to the end of the list only, because ordinal values of this enum are used
    ...
    // anton
    public static interface PositionAndDurationListener extends ResponseListener<Pair<Long, Long>> { }
